...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_IN16
    */
    GPIO_InitStruct.Pin = M1_HALL_U_Pin|M1_HALL_V_Pin|M1_HALL_W_Pin|M1_TEMPERATURE_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(GPIOC, M1_HALL_U_Pin|M1_HALL_V_Pin|M1_HALL_W_Pin|M1_TEMPERATURE_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC11     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = UART_TX_LOG_Pin|UART_RX_LOG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = UART_TX_CMD_Pin|UART_RX_CMD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART_TX_LOG_Pin|UART_RX_LOG_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, UART_TX_CMD_Pin|UART_RX_CMD_Pin);
