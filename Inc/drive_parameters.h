...
#define PID_TORQUE_KP_DEFAULT         3351
#define PID_TORQUE_KI_DEFAULT         2636
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3351
#define PID_FLUX_KI_DEFAULT           2636
...
#define PID_SPEED_KI_DEFAULT          3376/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          26 /*!< Over-voltage
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V          21 /*!< Under-voltage
                                                          threshold */
